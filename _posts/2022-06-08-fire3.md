...
I do my analysis is with a [Kaggle notebook](https://www.kaggle.com/code/emilykchang/stats-project-wildfire-risk) with the dataset [1.88 Million US Wildfires](https://www.kaggle.com/datasets/rtatman/188-million-us-wildfires). I use the following packages:
