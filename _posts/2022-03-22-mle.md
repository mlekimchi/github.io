...
Likelihood is reverse probability: [Bayes for Beginners](https://www.psychologicalscience.org/observer/bayes-for-beginners-probability-and-likelihood)


The Likelihood Principle and Baye's Factor: [Understanding Bayes](https://alexanderetz.com/2015/04/15/understanding-bayes-a-look-at-the-likelihood/)

Likelihood for a set of specific parameters is a conditional probability : [Is likelihood a conditional probability?](https://www.quora.com/Is-likelihood-a-conditional-probability)
