...
if (python code):
  put it here
```
# $$\hskip-1mm\boldsymbol{\hat{\hskip1mm\theta}}$$
...
I just learned about order statistics. Basicially, you sample from a distribution $$Y$$ and then order the data in ascending order. We can build a new distribution for the probabilities of the $$\prime_n$$ ordered number. If you want the distribution of the smallest value in a sample of size $$n$$, it would be called $$Y\prime_{min}$$
