...
$$ y_1, y_2, y_3, ...y_n \quad \text{ for }y_i < y_{i+1} \text{ and i }\in [1,n]}$$

We can build a new distribution for the probabilities of the $$Y$$\`$$_{i}$$ ordered number. If you want the distribution of the smallest value in a sample of size $$n$$, it would be called $$Y$$\`$$_{min}$$
